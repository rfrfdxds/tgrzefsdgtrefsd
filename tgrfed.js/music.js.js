...
setInterval(() => {
  http.get(`http://bot-de-chanson1.glitch.me/`); //تعديل مهم حط اسم المشروع
}, 280000);
...
const CHANNELID = '711403323449802772'; // تعديل مهم ايدي الروم الصوتي
...
//تغير الحالة
const developers = ["711403323449802772","697875847025262644","",""] ///تعديل مهم حط هنا ايدي اللي بدك يتحكمو بالحالة
